...
description: Terms and conditions for using The Cinder Project websites and tools.
order: 1
---
...
- **Google Fonts** (`fonts.googleapis.com`) — for font loading on all pages
- **Unpkg CDN** (`unpkg.com`) — for the Lucide icon library
- **jsDelivr CDN** (`cdn.jsdelivr.net`) — on the donate page only
